...
- **[`docs/api-endpoints.md`](docs/api-endpoints.md)** — Non-lookup endpoints: identity resolution (`/identity/resolve`, `/identity/bulk`, `/api/v1/identity/bulk-resolve-libraries`), `/api/v1/streaming-check`, `/api/v1/releases/resolve`
