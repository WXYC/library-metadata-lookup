...
class Settings(BaseSettings):
    ...
    lml_bulk_bandcamp_streaming_warm: bool = Field(
        ...
        description=(
            ...
            "that drain completes, watching the cache_miss_enqueued warm "
            "counters. Extends the #1052 bulk warm (Spotify, rowless-only) to "
            "Bandcamp with the same rowless scope; #1052 deliberately kept the "
